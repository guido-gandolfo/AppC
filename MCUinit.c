...
**     Date/Time : 2019-05-21, 09:59, # CodeGen: 3
**     Abstract  :
...
volatile char FLAG_temp= 0;
volatile char FLAG_reloj= 0;
...
void MCU_init(void)
{
  ...
  /* ### Init_RTC init code */
  /* RTCMOD: RTCMOD=0x31 */
  RTCMOD = 0x31U;                      /* Set modulo register */
...
{
static char conttmp=0;
static char contclk=0;
